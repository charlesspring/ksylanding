// Site Footer 1 - Updated September 24, 2023
function noop() { }
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t0 = space();
			span = element("span");
			t1 = text("© Copyright 2021 Skyisland All Rights Reserved.");
			t2 = space();
			div = element("div");
		...
		l(nodes) {
			...
			t1 = claim_text(span_nodes, "© Copyright 2021 Skyisland All Rights Reserved.");
